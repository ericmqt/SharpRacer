...
internal static class TrackingNames
{
    ...
    public static string DescriptorsGeneratorModelValueProvider_GetValueProvider { get; } = "DescriptorsGeneratorModelValueProvider_GetValueProvider";
    ...
    public static string VariableModelsValueProvider_GetValuesProvider { get; } = "VariableModelsValueProvider.GetValuesProvider";
    public static string VariableModelsValueProvider_GetVariableOptionsProvider { get; } = "VariableModelsValueProvider.GetVariableOptionsProvider";
    public static string VariableInfoFileProvider_GetValueProvider { get; } = "VariableInfoFileProvider.GetValueProvider";
    public static string VariableOptionsFileProvider_GetValueProvider { get; } = "VariableOptionsFileProvider.GetValueProvider";
}
