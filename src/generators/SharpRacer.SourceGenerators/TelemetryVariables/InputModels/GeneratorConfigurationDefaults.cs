...
internal static class GeneratorConfigurationDefaults
{
    ...
    public static VariableInfoFileName VariableInfoFileName { get; } = new VariableInfoFileName();
    public static VariableOptionsFileName VariableOptionsFileName { get; } = new VariableOptionsFileName();
}
