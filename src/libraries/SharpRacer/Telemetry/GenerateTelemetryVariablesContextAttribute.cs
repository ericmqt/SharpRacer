...
{
    /// <summary>
    /// Initializes an instance of <see cref="GenerateTelemetryVariablesContextAttribute"/>.
    /// </summary>
    public GenerateTelemetryVariablesContextAttribute()
    {

    }

    /// <summary>
    /// Initializes an instance of <see cref="GenerateTelemetryVariablesContextAttribute"/> with the specified variable names file.
    /// </summary>
    ...
    /// </param>
    public GenerateTelemetryVariablesContextAttribute(string includedVariableNamesFile)
    {
